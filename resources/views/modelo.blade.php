                    ...
                    <div class="header-actions">
                        ...
                        <div class="header-login">
                            <div class="header-sign-in">
                                <a href="{{ route('login') }}" class="br-sign-in small" type="button" data-trigger="login">
                        ...
                        <div class="header-login">
                            <div class="header-sign-in">
                                <a href="{{ route('register') }}" class="br-sign-in small" type="button" data-trigger="login">
                                    <i class="fas fa-user" aria-hidden="true"></i>
                                    <span class="d-sm-inline">Registrar</span>
                                </a>
                            </div>
                            <div class="header-avatar"></div>
                        </div>
                ...
                <div class="header-bottom">
                    <div class="header-menu">
                        ...
                        <div class="header-info">
                            <div class="header-title">Template básico em <a href="https://laravel.com/docs/" target="_blank">Laravel</a></div>
                                ...
                                <div class="col-sm d-flex">
                                    <div class="br-card">
                                        ...
                                        <div class="card-content">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laboriosam cupiditate nihil facere autem dignissimos ex beatae labore? Fuga consequuntur consectetur voluptatum incidunt, tenetur, dolore magnam inventore hic iusto amet ipsa.
                                        </div>
