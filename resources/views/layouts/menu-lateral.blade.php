    ...
    <div class="menu-container">
        <div class="menu-panel">
            ...
            <nav class="menu-body" role="tree">
                    ...
                    <ul>
                        <li>
                            <a class="menu-item" href="javascript: void(0)" role="treeitem">
                                ...
                                <span class="content">Camada 2</span>
                            </a>
                        </li>
                        <li>
                            <a class="menu-item" href="javascript: void(0)" role="treeitem">
                            ...
                            <ul>
                                <li>
                                    <a class="menu-item" href="javascript: void(0)" role="treeitem">
                                        ...
                                        <span class="content">Camada 3</span>
                                    </a>
                                </li>
                                <li>
                                    <a class="menu-item" href="javascript: void(0)" role="treeitem">
                                    ...
                                    <ul>
                                        <li>
                                            <a class="menu-item" href="javascript: void(0)" role="treeitem">
                                                <span class="content">Camada 4</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="menu-item" href="javascript: void(0)" role="treeitem">
                ...
                <a class="menu-item divider" href="javascript: void(0)" role="treeitem">
                  <span class="icon">
                    <i class="fas fa-bell" aria-hidden="true"></i>
                  </span>
                    <span class="content">Item de Camada 1</span>
                </a>
                <a class="menu-item divider" href="javascript: void(0)" role="treeitem">
                      <span class="icon">
                        <i class="fas fa-bell" aria-hidden="true"></i>
